...
#include "../../../codes/core/MyProgressDialog.h"
...
const QMetaObject MyProgressDialog::staticMetaObject = {
    { &QProgressDialog::staticMetaObject, qt_meta_stringdata_MyProgressDialog.data,
      qt_meta_data_MyProgressDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *MyProgressDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MyProgressDialog.stringdata0))
        return static_cast<void*>(const_cast< MyProgressDialog*>(this));
